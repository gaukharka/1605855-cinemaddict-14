...
const createGenresTemplate = (genre) => {
  return `<span class="film-details__genre">${genre}
  </span>`;
};

const createCommentTemplate = (comments) => {
  const {author, comment, data, emotion } = comments;
...
export {createPopupTemplate, createGenresTemplate, createCommentTemplate};
